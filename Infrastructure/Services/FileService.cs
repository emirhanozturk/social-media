...
namespace Infrastructure.Services
{
    public class FileService : IFileService
    {
        ...
        public async Task<List<(string fileName, string path)>> UploadAsync(string path, IFormFileCollection files)
        {
            ...
            return null;
            //todo Eğer ki yukarıdaki if geçerli değilse burada dosyaların sunucuda yüklenirken hata alındığına dair uyarıcı bir exception oluşturulup hata fırlatılması gerekiyor.
        }
    }
}
